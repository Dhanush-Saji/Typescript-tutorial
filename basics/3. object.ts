...
//There is one problem with the Typescript, Here I didn't define the email, but still, Typescript allows me to pass that in the function call. That's a problem from the Typescript side.
